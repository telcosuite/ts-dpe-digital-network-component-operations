# Digital Network Component Operations P01 - From Scratch App Foundation And Delivery Runtime Development Tasks
...
Phase rationale: The planning repository currently contains planning, database, TMF reference, and generated backlog artifacts but no runnable GitHub implementation repository for `digital-network-component-operations`. This phase bootstraps app repository `ts-dpe-digital-network-component-operations` with Angular/PrimeNG frontend, Spring Boot backend, PostgreSQL migration baseline, contracts, security context, event/outbox baseline, local Docker Compose workflow, GitHub Actions from `ts-shared-pipeline-templates`, Kubernetes/Helm deployment skeleton, observability, and a proof vertical slice before feature implementation begins.

Phase exit gate: A developer can clone `ts-dpe-digital-network-component-operations`, run the Angular shell and Spring Boot service, apply app-owned migrations for `digital_network_components`, execute baseline tests, validate Docker Compose and Kubernetes/Helm deployment assets, and prove a minimal UI-to-API-to-database-to-audit/event path with tracker evidence.
...
- Creates the runnable GitHub app repository `ts-dpe-digital-network-component-operations` and app surface needed before domain feature phases can be built.
...
- Adopts the TMF-aligned primary APIs: TMF910, TMF909, TMF620, TMF641, TMF638, TMF640, TMF908, TMF637.

## Default Scaffold Targets

Use these app-repository-relative targets for `ts-dpe-digital-network-component-operations` unless `DT-01-digital-network-component-operations-P01-T001` records an approved architecture exception:

- GitHub app repository: `ts-dpe-digital-network-component-operations` with `README.md`, `OWNERS.md`, `CODEOWNERS`, protected `main`, required GitHub Actions checks, security scanning, copied `dev-tasks/`, and planning source commit/link recorded in `docs/architecture.md` or an ADR.
- Shared prerequisites: consume versioned UI/design-system assets from `ts-shared-ui-design-system` and GitHub Actions workflow templates from `ts-shared-pipeline-templates`; app-specific UI, domain logic, migrations, and telecom lifecycle decisions remain in `ts-dpe-digital-network-component-operations`.
...
- Spring Boot service: `backend/` with package `com.telcosuite.dpe.digital_network_components`, including `controller/`, `service/`, `domain/`, `repository/`, `security/`, `events/`, and `config/`.
...
- Database migrations: `database/postgres/migrations/` and `database/postgres/seeds/` with app-owned changes for schema `digital_network_components`, audit/evidence, idempotency, outbox, seed/demo data, and rollback/repair notes.
...
### DT-01-digital-network-component-operations-P01-T001: Bootstrap GitHub app repository and ownership boundary

| Field | Value |
| --- | --- |
| Phase | P01 - From Scratch App Foundation And Delivery Runtime |
| Priority | P0 |
| Source evidence | [Implementation usage](../planning/app-detail/implementation-file-usage.md), [App README](../README.md), [App overview](../../digital-network-component-operations.md), [Modules and features](../planning/app-detail/modules-and-features.md), [Personas and journeys](../planning/app-detail/personas-and-user-journeys.md), [Suite tech/UI guidance](../../tech-and-ui-guidance.md), [Suite data model](../../data-model.md), [Suite implementation guide](../../implementation-file-usage-guide.md), [TMF review](../../tmf-api-ddl-reviews/digital-network-components.md), [App migration](../../../../../database/postgres/suites/ts_digital_partner_ecosystem/V001__create_app_schemas_and_starter_tables.sql), [API-first architecture](../../../../api-first-product-suite-architecture.md), [Technology stack guidance](../../../../technology-stack-guidance.md), [UI design system](../../../../telcosuite-ui-design-system.md), [Database setup guidance](../../../../recommended-database-setup.md), [Data mastery ownership](../../../../data-mastery-entity-ownership.md) |
| Feature or module | From-scratch app foundation |
| Build area | Architecture/Docs |
| Dependencies | External: suite/app evidence chain |
| Outputs | GitHub repository `ts-dpe-digital-network-component-operations`, app boundary decision, copied `dev-tasks/`, ownership files, branch protection/check policy, app-root workspace names, and source-evidence map. |

#### Implementation Notes

- Confirm that `ts-dpe-digital-network-component-operations` is the implementation repository for this app and record the intended frontend, backend, database, test, CI, Docker Compose, Kubernetes/Helm, and deployment locations before code scaffolding starts.
- Map the app-owned schema `digital_network_components`, TMF/API posture (TMF910, TMF909, TMF620, TMF641, TMF638, TMF640, TMF908, TMF637), personas, feature folders, repository ownership, shared repository dependencies, and cross-app boundaries to concrete implementation artifacts.
...
- Default artifact map: GitHub repo `ts-dpe-digital-network-component-operations` with app-root `frontend/`, `backend/`, `contracts/openapi/v1/openapi.yaml`, `contracts/events/`, `database/postgres/migrations/`, `database/postgres/seeds/`, `docs/`, `dev-tasks/`, `.github/workflows/ci.yml`, `.github/workflows/release.yml`, `deploy/compose/`, `deploy/k8s/`, and `deploy/helm/`.
- Bootstrap governance files: `README.md`, `OWNERS.md`, `CODEOWNERS`, branch protection configuration or evidence, required GitHub Actions checks, and security scanning policy for `ts-dpe-digital-network-component-operations`.
...
2. Given `digital-network-component-operations` uses app-owned schema `digital_network_components`, when the task creates code, config, migrations, contracts, or test fixtures, then writes remain inside that schema and cross-app data access is represented as API, event, workflow, projection, or data product dependency.
...
5. Given a clean checkout of `ts-dpe-digital-network-component-operations`, when the documented commands are run in dependency order, then the task output is reproducible without manual, undocumented setup.
6. Given `ts-dpe-digital-network-component-operations` is bootstrapped, when repository governance is reviewed, then `README.md`, `OWNERS.md`, `CODEOWNERS`, branch protection evidence, required GitHub Actions checks, security scanning, copied `dev-tasks/`, and planning source commit/link are present.
...
### DT-01-digital-network-component-operations-P01-T002: Create Angular application shell and suite navigation entry

| Field | Value |
| --- | --- |
| Phase | P01 - From Scratch App Foundation And Delivery Runtime |
| Priority | P0 |
| Source evidence | [UI design system](../../../../../telcosuite-ui-design-system.md), [App summary](../../../../../digital-network-component-operations.md), [Personas](../../../../../digital-network-component-operations-personas.md) |
| Feature or module | From-scratch app foundation |
| Build area | UI |
| Dependencies | DT-01-digital-network-component-operations-P01-T001 |
...
### DT-01-digital-network-component-operations-P01-T003: Create Spring Boot service skeleton and runtime configuration

| Field | Value |
| --- | --- |
| Phase | P01 - From Scratch App Foundation And Delivery Runtime |
| Priority | P0 |
| Source evidence | [API-first architecture](../../../../../api-first-product-suite-architecture.md), [Technology stack guidance](../../../../../technology-stack-guidance.md), [App summary](../../../../../digital-network-component-operations.md) |
| Feature or module | From-scratch app foundation |
| Build area | API/Ops |
| Dependencies | DT-01-digital-network-component-operations-P01-T002 |
...
- Set the Java package under `com.telcosuite.dpe.digital_network_components`.
...
### DT-01-digital-network-component-operations-P01-T004: Establish PostgreSQL migration, schema, repository, and seed baseline
...
| Feature or module | From-scratch app foundation |
| Build area | Data |
| Dependencies | DT-01-digital-network-component-operations-P01-T003 |
...
- Keep the app's write/read models in schema `digital_network_components`.
...
1. Given a clean PostgreSQL database, when Flyway runs the app's migrations, then only schema `digital_network_components` and its tables are created.
...
### DT-01-digital-network-component-operations-P01-T005: Define TMF/OpenAPI contract workspace and API versioning baseline

| Field | Value |
| --- | --- |
| Phase | P01 - From Scratch App Foundation And Delivery Runtime |
| Priority | P0 |
| Source evidence | [TMF review](../../tmf-api-ddl-reviews/digital-network-components.md), [API-first architecture](../../../../api-first-product-suite-architecture.md) |
| Feature or module | From-scratch app foundation |
| Build area | API/Test |
| Dependencies | DT-01-digital-network-component-operations-P01-T004 |
...
### DT-01-digital-network-component-operations-P01-T006: Implement authentication, authorization, tenant, and evidence context baseline
...
| Feature or module | From-scratch app foundation |
| Build area | Security |
| Dependencies | DT-01-digital-network-component-operations-P01-T005 |
...
### DT-01-digital-network-component-operations-P01-T007: Create event, outbox, workflow, and integration contract baseline
...
| Dependencies | DT-01-digital-network-component-operations-P01-T006 |
...
- `event_outbox` table in schema `digital_network_components`.
...
### DT-01-digital-network-component-operations-P01-T008: Build shared app UI patterns for queues, records, forms, dashboards, and evidence views

| Field | Value |
| --- | --- |
| Phase | P01 - From Scratch App Foundation And Delivery Runtime |
| Priority | P1 |
| Source evidence | [UI design system](../../../../../telcosuite-ui-design-system.md), [App summary](../../../../../digital-network-component-operations.md) |
| Feature or module | From-scratch app foundation |
| Build area | UI/Test |
| Dependencies | DT-01-digital-network-component-operations-P01-T007 |
...
### DT-01-digital-network-component-operations-P01-T009: Add local developer environment, run scripts, seed data, and demo smoke flow
...
| Dependencies | DT-01-digital-network-component-operations-P01-T008 |
...
### DT-01-digital-network-component-operations-P01-T010: Wire CI quality gates and test pyramid scaffolding
...
| Feature or module | From-scratch app foundation |
| Build area | CI/Test |
| Dependencies | DT-01-digital-network-component-operations-P01-T009 |
...
### DT-01-digital-network-component-operations-P01-T011: Establish observability, operations, support, and deployment skeleton
...
| Dependencies | DT-01-digital-network-component-operations-P01-T010 |
...
### DT-01-digital-network-component-operations-P01-T012: Prove the first end-to-end vertical slice through UI, API, database, event, security, and CI

| Field | Value |
| --- | --- |
| Phase | P01 - From Scratch App Foundation And Delivery Runtime |
| Priority | P0 |
| Source evidence | [Repository strategy](../../../../repository-strategy.md), [App summary](../../../../../digital-network-component-operations.md) |
| Feature or module | From-scratch app foundation |
| Build area | Full-stack/Test/Release |
| Dependencies | DT-01-digital-network-component-operations-P01-T011 |
