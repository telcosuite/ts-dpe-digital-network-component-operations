# Digital And Network Component Operations App Personas And User Journeys
...
| ---: | --- | --- | --- |
| 1 | Package reusable components for self-care, NaaS, IoT devices, and IoT services. | App validates context, permissions, dependencies, and lifecycle state. | App-owned record, event, task, projection, or handoff is updated. |
| 2 | Link components to catalog offers, service orders, inventory, activation, assurance, usage, billing, and portal exposure. | App validates context, permissions, dependencies, and lifecycle state. | App-owned record, event, task, projection, or handoff is updated. |
| 3 | Manage component configuration, lifecycle, dependencies, health, adoption, and release state. | App validates context, permissions, dependencies, and lifecycle state. | App-owned record, event, task, projection, or handoff is updated. |
| 4 | Provide operational views for partner/developer-facing component usage and customer-impacting status. | App validates context, permissions, dependencies, and lifecycle state. | App-owned record, event, task, projection, or handoff is updated. |

## Persona Journeys

## Persona Journey 1: NaaS product manager

Need: exposes API-driven network capabilities as products.

Typical journey:

1. Opens the app from a work queue, customer/account context, operational dashboard, external notification, or direct search.
2. Reviews relevant records, relationships, history, policy flags, and open exceptions across modules such as Self-Care Component Operations, NaaS Component Operations, IoT Agent And Device Operations, IoT Service Operations.
...
## Persona Journey 2: IoT operations user

Need: manages device and IoT service lifecycle.
...
## Persona Journey 3: API product manager

Need: packages component suites for developers and partners.
...
## Persona Journey 4: Channel product owner

Need: embeds self-care components into web, mobile, partner, or embedded experiences.
...
## Persona Journey 5: Operations user

Need: monitors component health, configuration, dependencies, and adoption.
...
The app should support journeys that cross these modules: Self-Care Component Operations, NaaS Component Operations, IoT Agent And Device Operations, IoT Service Operations.
